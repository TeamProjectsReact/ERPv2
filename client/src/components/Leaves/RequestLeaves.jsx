                                                    ...
                                                    <td>
                                                        {
                                                            (() => {
                                                                if(leaves.Status === "Requested"){
                                                                    ...
                                                                    return (
                                                                        <div className="md:flex">
                                                                            <button onClick={() => headleApprove(leaves._id)} className='mx-1 w-full md:my-0 my-1 bg-blue-500 text-white py-1 px-3 rounded shadow-md duration-500 hover:bg-blue-600'>Approve</button>
